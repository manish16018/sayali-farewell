...
export const Details = [
    ...
    {
        Name : "Amit Yadav",
        Comment  : "<i>\"You have become Inspiration, Destroyer of all hardships to us\"</i>.<br>My first manager.<br>You have set high standards for my future managers.<br>Hope I will be able to meet u one day.<br> Best of luck for your future.",
        imgUrl : penguin,
        alt : "penguin GIF"
    },
    {
